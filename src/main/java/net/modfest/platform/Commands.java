...
public class Commands {
    ...
    public static List<ApplicationCommandRequest> getGuildCommands() {
        ApplicationCommandRequest registerCommand = ApplicationCommandRequest.builder()
                .name("register")
                .description("Register for " + (DataManager.hasActiveEvent() ? DataManager.getActiveEvent()
                        .name() : "ModFest"))
                .build();
        ...
        ApplicationCommandRequest eventCommand = ApplicationCommandRequest.builder()
                .name("event")
                .description("Unregister yourself from " + (DataManager.hasActiveEvent() ? DataManager.getActiveEvent()
                        .name() : "ModFest"))
                ...
                .addOption(ApplicationCommandOptionData.builder()
                        .name("submit")
                        .description("Submit a mod for " + (DataManager.hasActiveEvent() ? DataManager.getActiveEvent()
                                .name() : "ModFest"))
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("unsubmit")
                        .description("Retract a submission for " + (DataManager.hasActiveEvent() ? DataManager.getActiveEvent()
                                .name() : "ModFest"))
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("submission")
        ...
        ApplicationCommandRequest adminCommand = ApplicationCommandRequest.builder()
                ...
                .addOption(ApplicationCommandOptionData.builder()
                        .name("migrate")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Migrate old data with new fixes")
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("fixroles")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                ...
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setactiveevent")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Sets the active event")
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("event")
                                .description("Event to set to active")
                                .required(true)
                                .autocomplete(true)
                                .type(ApplicationCommandOption.Type.STRING.getValue())
                                .build())
                ...
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setphasemodding")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Set name of current event to MODDING")
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setphaseshowcase")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Set name of current event to SHOWCASE")
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setphasecomplete")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Set name of current event to COMPLETE")
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setphasebuilding")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Set name of current event to BUILDING")
                        .build())
                .addOption(ApplicationCommandOptionData.builder()
                        .name("setphaseplanning")
                        .type(ApplicationCommandOption.Type.SUB_COMMAND.getValue())
                        .description("Set name of current event to PLANNING")
                        .build())
                /*.addOption(ApplicationCommandOptionData.builder()
                        .name("createevent")
                        ...
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("id")
                                .description("ID and URL slug for the event")
                                .required(true)
                                .type(ApplicationCommandOption.Type.STRING.getValue())
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                        ...
                        .addOption(ApplicationCommandOptionData.builder()
                                ...
                                .description("Background color of the event (as hex code)")
                                .type(ApplicationCommandOption.Type.STRING.getValue())
                                .required(true)
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("primarycolor")
                                .description("Primary color of the event (as hex code)")
                                .type(ApplicationCommandOption.Type.STRING.getValue())
                                .required(true)
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("participantrole")
                                .description("Participant role for the event")
                                .type(ApplicationCommandOption.Type.ROLE.getValue())
                                .required(true)
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("awardrole")
                                .description("Award role for the event")
                                .type(ApplicationCommandOption.Type.ROLE.getValue())
                                .required(true)
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("oneoff")
                                .description("Whether or not the event is a one-off")
                                .type(ApplicationCommandOption.Type.BOOLEAN.getValue())
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("archived")
                                .description("Whether or not the event is archived")
                                .type(ApplicationCommandOption.Type.BOOLEAN.getValue())
                                .build())
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("published")
                        ...
                        .addOption(ApplicationCommandOptionData.builder()
                                .name("logo")
                                .description("SVG of the event's logo")
                                .type(ApplicationCommandOption.Type.STRING.getValue())
                                .build())
                        .build())*/.addOption(ApplicationCommandOptionData.builder()
